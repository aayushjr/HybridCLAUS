...
Code from https://github.com/xuyxu/Deep-Clustering-Network
For the paper Yang et al. ''Towards K-means-friendly Spaces: Simultaneous Deep Learning and Clustering'', ICML-2017 (https://arxiv.org/pdf/1610.04794.pdf)
...
class batch_KMeans(object):
    ...
    def init_cluster(self, X, indices=None):
        ...
        model = KMeans(n_clusters=self.n_clusters,
                       n_init=20)
        model.fit(X)
        self.clusters = np.copy(model.cluster_centers_)  # copy clusters
        self.model = model
    ...
    def assign_cluster(self, cluster_centers):
